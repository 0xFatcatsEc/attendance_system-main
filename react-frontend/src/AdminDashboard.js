                    ...
                    <tbody>
                      {users.filter(u => u.role === 'teacher').map((user) => (
                        <tr key={user.id}>
                          ...
                          <td>{user.email}</td>
                          <td>
                            {user.courses && (typeof user.courses === 'string' ? JSON.parse(user.courses) : user.courses).length > 0 ? (
                              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '5px' }}>
                                {(typeof user.courses === 'string' ? JSON.parse(user.courses) : user.courses).map(course => (
                          ...
                          <td>
                            {user.yearLevel && (typeof user.yearLevel === 'string' ? JSON.parse(user.yearLevel) : user.yearLevel).length > 0 ? (
                              <span style={{ fontSize: '12px' }}>{(typeof user.yearLevel === 'string' ? JSON.parse(user.yearLevel) : user.yearLevel).join(', ')}</span>
                            ) : (
                              <span style={{ color: 'var(--muted)', fontSize: '12px' }}>None</span>
                            )}
                          </td>
                          <td>
                            {user.sections && (typeof user.sections === 'string' ? JSON.parse(user.sections) : user.sections).length > 0 ? (
                              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '5px' }}>
                                {(typeof user.sections === 'string' ? JSON.parse(user.sections) : user.sections).map(section => (
